...
#         print(list(prediction_input.keys()))
...
#             return list((prediction_input["file_path"], prediction_input["image"], masks))
    ...
    def postprocess(self, prediction_results: Dict) -> Dict:
        ...
        #     prediction["masks"] = prediction_results[1]
        #     prediction["scores"] = prediction_results[2]
        #     prediction["logits"] = prediction_results[3]
        # else:
        #     """ Prediction response / Masking without prompts / automatic masking """
        #     prediction["file_path"] = prediction_results[0]
        #     prediction["image"] = prediction_results[1]
        #     prediction["masks"] = prediction_results[2]
